...
from app.schemas.auth import LoginRequest, LoginResponse, ProfileUpdateRequest, RegisterRequest, UserResponse
...
def upload_my_avatar(
    ...
    return update_current_user_avatar(db, current_user, file)
